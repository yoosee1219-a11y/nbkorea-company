            ...
            >
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full bg-nb-pink-600 hover:bg-nb-pink-700 text-white font-bold py-4 px-6 rounded-lg transition-all shadow-lg shadow-nb-pink-600/30 hover:shadow-nb-pink-600/50 flex items-center justify-center gap-2"
                >
                  문의 보내기 <Send size={20} />
                </motion.button>
              </form>
